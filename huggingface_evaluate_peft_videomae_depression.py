...
learning_rate = 1e-3
lora_rank = 8
# run_name = f'videomae_base_peft_dc_dep_e{epochs}_bs{batch_size}_lr{learning_rate}_r{lora_rank}'
run_name = f'videomae_base_peft_dep_e{epochs}_bs{batch_size}_lr{learning_rate}_r{lora_rank}'
