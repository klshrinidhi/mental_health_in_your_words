...
target_modules = ['dense','classifier'] # 'all-linear'
run_name = f'videomae_base_bin_peft_dc_dep_e{epochs}_bs{batch_size}_lr{learning_rate}_r{lora_rank}'
...
def train_and_evaluate(train_f, val_f):
    ...
    model = AutoModelForVideoClassification.from_pretrained(model_name,
                                                            ...
                                                            torch_dtype='auto',
                                                            trust_remote_code=True)
    peft_config = LoraConfig(r=lora_rank,target_modules=target_modules)
