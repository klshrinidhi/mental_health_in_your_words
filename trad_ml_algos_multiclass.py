...
def compute_metrics_anx(labels_train,preds_train,labels_test,preds_test):
    ...
    anx_f1_train.append(skm.f1_score(labels_train,preds_train,average='weighted'))
    anx_f1_test.append(skm.f1_score(labels_test,preds_test,average='weighted'))
    anx_precision_train.append(skm.precision_score(labels_train,preds_train,average='weighted'))
    anx_precision_test.append(skm.precision_score(labels_test,preds_test,average='weighted'))
    anx_recall_train.append(skm.recall_score(labels_train,preds_train,average='weighted'))
    anx_recall_test.append(skm.recall_score(labels_test,preds_test,average='weighted'))
...
def compute_metrics_dep(labels_train,preds_train,labels_test,preds_test):
    ...
    dep_f1_train.append(skm.f1_score(labels_train,preds_train,average='weighted'))
    dep_f1_test.append(skm.f1_score(labels_test,preds_test,average='weighted'))
    dep_precision_train.append(skm.precision_score(labels_train,preds_train,average='weighted'))
    dep_precision_test.append(skm.precision_score(labels_test,preds_test,average='weighted'))
    dep_recall_train.append(skm.recall_score(labels_train,preds_train,average='weighted'))
    dep_recall_test.append(skm.recall_score(labels_test,preds_test,average='weighted'))
...
df_scores.write_csv(mental_health_d / 'accuracy_openai_embs_sklearn_classifiers_valsets_mean.csv')
# df_scores.write_csv(mental_health_d / 'accuracy_google_embs_sklearn_classifiers_valsets_mean.csv')