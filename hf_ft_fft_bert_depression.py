...
argparser.add_argument('--i_beg',type=int,default=12)
...
batch_size = 8
learning_rate = 5e-5
run_name = f'bert_base_dep_e{epochs}_bs{batch_size}_lr{learning_rate}'
...
for train_f,val_f in tqdm(list(zip(train_fs,val_fs))[args.i_beg:args.i_end],desc='dep'):
